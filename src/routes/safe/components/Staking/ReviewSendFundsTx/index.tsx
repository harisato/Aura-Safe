...
const ReviewSendFundsTx = ({
  ...
  const txRecipient = itemValidator?.safeStaking || ''
  ...
  const msgSendGas = chainDefaultGas.find((chain) => chain.typeUrl === typeStaking)
      ...
      {(txParameters, _) => (
        <>
          ...
          <Block className={classes.container}>
            ...
            {/* Recipient */}
            {typeStaking !== TypeStaking?.reward && (
              <>
                <Row margin="xs">
