...
const SendPopup = ({
  ...
  const handleSubmit = (values) => {
    ...
    onReview && onReview({ ...submitValues, tokenSpendingLimit })
  }
  ...
  return (
    <>
      <Popup open={open} title="Send Popup">
        <PopupWrapper>
          <Header onClose={onClose} subTitle="Step 1 of 2" title="Send funds" />
          <BodyWrapper>
            <CurrentSafe />
            <Divider withArrow />
      ...
      <CreateTxPopup open={createTxPopupOpen} handleClose={() => setCreateTxPopupOpen(false)} />
    </>
  )
}
