...
export const DEFAULT_CHAIN_ID = IS_PRODUCTION ? CHAIN_ID.AURA_SERENITY : CHAIN_ID.AURA_SERENITY
...
export const MSAFE_GATEWAY_URL = 'https://safe.dev.aura.network/api'
