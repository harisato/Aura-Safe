...
import { coin, MsgDelegateEncodeObject } from '@cosmjs/stargate'
...
export default function Delegate({ validator, amount, onClose, createTxFromApi }) {
  ...
  const defaultGas =
    chainDefaultGas.find((chain) => chain.typeUrl === MsgTypeUrl.Delegate)?.gasAmount || DEFAULT_GAS_LIMIT.toString()
  const gasFee =
  ...
  const signTransaction = async () => {
    ...
    const Msg: MsgDelegateEncodeObject['value'] = {
