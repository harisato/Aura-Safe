...
const createERC20TokenContract = (tokenAddress: string): ERC20 => {
  const web3 = getWeb3()
  return new web3.eth.Contract(ERC20Contract.abi as any[], tokenAddress) as unknown as ERC20
}

const createERC721TokenContract = (tokenAddress: string): ERC721 => {
  const web3 = getWeb3()
  return new web3.eth.Contract(ERC721Contract.abi as any[], tokenAddress) as unknown as ERC721
}
